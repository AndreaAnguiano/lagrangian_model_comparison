...
if __name__ == '__main__':
    ...
    model = make_model(timeStep,startDate, duration, weatheringSteps, map, uncertain, data_path, reFloatHalfLife, windFile, currFile, tidalFile, num_elements, depths, lat, lon)
